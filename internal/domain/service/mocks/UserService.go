...
func (_m *UserService) DeleteUser(ctx context.Context, userUUID uuid.UUIDModel) error {
...
func (_m *UserService) GetUser(ctx context.Context, userUUID uuid.UUIDModel) (*model.UserInfo, error) {
	ret := _m.Called(ctx, userUUID)

	var r0 *model.UserInfo
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUIDModel) *model.UserInfo); ok {
		r0 = rf(ctx, userUUID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.UserInfo)
