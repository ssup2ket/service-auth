...
func (_m *UserSecretRepo) Delete(ctx context.Context, userUUID uuid.ModelUUID) error {
...
func (_m *UserSecretRepo) Get(ctx context.Context, userUUID uuid.ModelUUID) (*model.UserSecret, error) {
	ret := _m.Called(ctx, userUUID)

	var r0 *model.UserSecret
	if rf, ok := ret.Get(0).(func(context.Context, uuid.ModelUUID) *model.UserSecret); ok {
		r0 = rf(ctx, userUUID)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, uuid.ModelUUID) error); ok {
		r1 = rf(ctx, userUUID)
	} else {
		r1 = ret.Error(1)
	}
