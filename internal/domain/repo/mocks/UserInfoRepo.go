...
// NewUserInfoRepo creates a new instance of UserInfoRepo. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserInfoRepo(t testing.TB) *UserInfoRepo {
	mock := &UserInfoRepo{}
	mock.Mock.Test(t)
