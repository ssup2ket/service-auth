...
func (_m *UserInfoRepo) Delete(ctx context.Context, userUUID uuid.ModelUUID) error {
...
func (_m *UserInfoRepo) Get(ctx context.Context, userUUID uuid.ModelUUID) (*model.UserInfo, error) {
	ret := _m.Called(ctx, userUUID)
