...
func (_m *UserInfoRepo) Delete(ctx context.Context, userUUID uuid.UUIDModel) error {
...
func (_m *UserInfoRepo) Get(ctx context.Context, userUUID uuid.UUIDModel) (*model.UserInfo, error) {
	ret := _m.Called(ctx, userUUID)
