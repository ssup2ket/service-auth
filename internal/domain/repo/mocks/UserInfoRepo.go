...
func (_m *UserInfoRepo) Delete(ctx context.Context, userUUID uuidmodel.UUIDModel) error {
...
func (_m *UserInfoRepo) Get(ctx context.Context, userUUID uuidmodel.UUIDModel) (*model.UserInfo, error) {
	ret := _m.Called(ctx, userUUID)
